...
- **Mobile (driver)**: Expo SDK 57 + React 19.2 + react-native 0.86 — `apps/mobile`
- **Mobile (passenger)**: Expo SDK 57 + React 19.2 + react-native 0.86 — `apps/mobile-passengers`
...
Quick ref:
- Same Expo SDK 57 family as the driver app
- expo-router (file-based routing)
